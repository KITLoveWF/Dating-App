...
┌──────────────┬──────────────┬──────────────┐
│  👤 Sarah    │  👤 Mike     │  👤 Emma     │
│  25 • Female │  28 • Male   │  26 • Female │
│              │              │              │
│  "Love art"  │  "Gym lover" │  "Traveler"  │
│              │              │              │
│  [❤️ Like]   │  [❤️ Like]   │  [❤️ Like]   │
└──────────────┴──────────────┴──────────────┘
```
...
│  📅 Schedule Your Date                   │
├─────────────────────────────────────────┤
│  From Date: [2026-03-01]  Time: [09:00] │
│  To Date:   [2026-03-01]  Time: [17:00] │
│                                          │
│  [Submit Availability]                   │
│                                          │
│  ─────────────────────                   │
...
```mermaid
graph LR
    A[Tạo Profile] --> B[Browse Profiles]
    B --> C{Like Profile}
    C -->|Mutual Like| D[💝 Match!]
    C -->|One-way Like| B
    D --> E[Schedule Date]
    E --> F[Submit Availability]
    F --> G{Both Submitted?}
    G -->|Yes| H[Check Overlap]
    G -->|No| I[Wait for Partner]
    H -->|Found| J[✅ Date Scheduled]
    H -->|Not Found| K[❌ Try Again]
```
...
│                    FRONTEND (Next.js)                    │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌─────────┐ │
│  │ Profile  │  │  Browse  │  │ Matches  │  │Schedule │ │
│  │  Create  │  │   Like   │  │ Display  │  │  Date   │ │
│  └────┬─────┘  └────┬─────┘  └────┬─────┘  └────┬────┘ │
└───────┼─────────────┼─────────────┼─────────────┼──────┘
        │             │             │             │
        └─────────────┴─────────────┴─────────────┘
...
│              BACKEND (NestJS)                             │
│  ┌──────────┐  ┌──────────┐  ┌─────────────────┐        │
│  │ Profiles │  │ Matchs   │  │ Availabilities  │        │
...
> **📝 Note:** Để thêm screenshots thực tế, chụp ảnh màn hình và lưu vào thư mục `docs/images/` trong project.
